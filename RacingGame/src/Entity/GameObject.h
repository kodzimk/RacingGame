...
{
public:
	GameObject(const std::string& filePath, const wchar_t* fileName, ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LPCWSTR vertexDir, LPCWSTR pixelDir, float depthZ);
	GameObject();
	~GameObject();
